                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/kai.WebInscription"
                            }
                        }
                    },
                    "400": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/kai.Mrc721GenesisDataWeb"
                            }
                        }
                    },
                    "400": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/kai.SimpleHookBlock"
                            }
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/kai.MRC721Protocol"
                        }
                    },
                    "400": {
                        "description": "Error message if retrieval fails",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/kai.HookInscription"
                        }
                    },
                    "400": {
                        "description": "Error message if retrieval fails",
    ...
    "definitions": {
        ...
        "kai.HookBlock": {
            ...
            "properties": {
                ...
                "transfers": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/kai.HookTransfer"
                    }
                }
            }
        },
        ...
        "kai.MRC721Protocol": {
            ...
            "properties": {
                ...
                "ltry": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/kai.Lottery"
                        }
                    ]
                },
                "miner": {
                    "$ref": "#/definitions/kai.Miner"
                },
                "p": {
                    "type": "string"
                },
                "token": {
                    "$ref": "#/definitions/kai.Token"
                }
            }
        },
        "kai.Miner": {
        ...
        "kai.WebCollections": {
            ...
            "properties": {
                ...
                "meta": {
                    "$ref": "#/definitions/kai.WebCollectionItem"
                }
            }
        },
        "kai.WebInscription": {
        ...
        "kai.WebMrcAllInscription": {
            "type": "object",
            "properties": {
                "genesis_data": {
                    "$ref": "#/definitions/kai.Mrc721GenesisData"
                },
                "inscription": {
                    "$ref": "#/definitions/kai.HookInscription"
                },
                "mrc20_protocol": {
                    "$ref": "#/definitions/kai.MRC20Protocol"
                },
                "mrc721_protocol": {
                    "$ref": "#/definitions/kai.MRC721Protocol"
                },
        ...
        "rpc.GetAddressMrc20BarData": {
            ...
            "properties": {
                "bars": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/kai.WebMrc20Bar"
                    }
                }
            }
        },
        ...
        "rpc.GetAddressMrc20ListData": {
            ...
            "properties": {
                ...
                "list": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/kai.WebMrc20Inscription"
                    }
                }
            }
        },
        ...
        "rpc.GetAddressMrc721BarPlusData": {
            ...
            "properties": {
                "bars": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/kai.WebMrc721Bar"
                    }
                }
            }
        },
        ...
        "rpc.GetAddressMrc721HoldersData": {
            ...
            "properties": {
                ...
                "holders": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/kai.WebMrc721Holder"
                    }
                }
            }
        },
        ...
        "rpc.GetBurnInfoResult": {
            ...
            "properties": {
                ...
                "data": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/kai.WebBurnInfo"
                        }
                    ]
                },
                "message": {
        ...
        "rpc.GetLotteryListData": {
            ...
            "properties": {
                "lotteries": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/kai.LotteryData"
                    }
                }
            }
        },
        ...
        "rpc.GetMrc721CollectionsResult": {
            ...
            "properties": {
                ...
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/kai.WebCollections"
                    }
                },
                "message": {
                    "type": "string"
        ...
        "rpc.WebMrcAllInscriptionResult": {
            ...
            "properties": {
                ...
                "data": {
                    "$ref": "#/definitions/kai.WebMrcAllInscription"
                },
                "message": {
                    "type": "string"
                }
