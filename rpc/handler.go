...
// @Success 200 {object} kai.HookBlock "Block information"
// @Failure 400 {object} string "Error message if retrieval fails"
...
// @Success 200 {array} kai.SimpleHookBlock "Array of blocks"
// @Failure 400 {object} string "Error message if retrieval fails"
...
type GetInscriptionResult struct {
	...
	Data    *kai.HookInscription `json:"data"`    // Data payload containing the inscription details, nil if error occurs
}
...
// @Success 200 {object} kai.MRC721Protocol "Parsed MRC721Protocol data"
...
func MiningProfitChart(g *gin.Context) {
	...
	var protocol kai.MRC721Protocol
...
// @Produce json
// @Param id query string true "Inscription ID"
// @Success 200 {object} kai.HookInscription "Inscription information"
// @Failure 400 {object} string "Error message if retrieval fails"
...
// @Accept json
// @Produce json
// @Success 200 {array} kai.Mrc721GenesisDataWeb "List of MRC-721 genesis inscriptions"
// @Failure 400 {object} string "Error message if retrieval fails"
...
// @Success 200 {object} kai.Mrc721GenesisDataWeb "MRC-721 genesis inscription"
// @Failure 400 {object} string "Error message if retrieval fails"
...
type GetAddressMrc721ListData struct {
	List     []kai.WebInscription `json:"list"`
...
// @Success 200 {array} kai.WebInscription "List of MRC-721 inscriptions"
// @Failure 400 {object} string "Error message if retrieval fails"
...
func GetAddressMrc721List(c *gin.Context) {
	...
	if inscriptions == nil {
		inscriptions = []kai.WebInscription{}
	}
...
type GetMrc721CollectionsResult struct {
	Code    int                  `json:"code"`
	Message string               `json:"message"`
	Data    []kai.WebCollections `json:"data"`
}
...
// @Success 200 {object} kai.MRC721Protocol "The MRC721 genesis protocol data"
// @Failure 400 {object} string "Error message if retrieval fails"
...
type GetAddressMrc20BarData struct {
	Bars []kai.WebMrc20Bar `json:"bars"`
}
...
func GetAddressMrc20Bar(c *gin.Context) {
	// Retrieve query parameters
	address := c.Query("address")
	// mrc20Name is non-required and defaults to if not provided ""
...
type GetAddressMrc20ListData struct {
	List     []kai.WebMrc20Inscription `json:"list"`
	AllCount int                       `json:"all_count"`
}
...
func GetAddressMrc20List(c *gin.Context) {
	...
	if inscriptions == nil {
		inscriptions = []kai.WebMrc20Inscription{}
	}
...
type GetAddressMrc721BarPlusData struct {
	Bars []kai.WebMrc721Bar `json:"bars"`
}
...
func GetAddressMrc721BarPlus(c *gin.Context) {
	...
	if webMrc721Bars == nil {
		webMrc721Bars = []kai.WebMrc721Bar{}
	}
...
type GetAddressMrc721HoldersData struct {
	Holders  []kai.WebMrc721Holder `json:"holders"`
	AllCount int                   `json:"all_count"`
}
...
type GetGenesisDataResult struct {
	...
	Data    kai.Mrc721GenesisData `json:"data"`    // Genesis data of a MRC-721 name
}
...
type GetBurnInfoResult struct {
	...
	Data    kai.WebBurnInfo `json:"data"`    // Burn information data
}
...
type WebMrcAllInscriptionResult struct {
	Code    int                      `json:"code"`
	Message string                   `json:"message"`
	Data    kai.WebMrcAllInscription `json:"data"`
}
...
type GetLotteryListData struct {
	Lotteries []kai.LotteryData `json:"lotteries"`
}
