...
// @version 1.01
// @termsOfService https://github.com/KingKaiBTC
...
func main() {
	...
	// 	panic(err)
	// }
	// err = cleanUpPreviousData(AppConfig.RecPath)
	// if err != nil {
	// 	logger.Error("Error cleaning RecPath up previous data", zap.Error(err))
	// 	panic(err)
	// }
	...
	// Create an instance of kai.BTOrdIdx using the dbManager
	btOrdIdx := kai.NewBTOrdIdx(db)
	...
	defer recDb.Close()
	btRecIdx := kai.NewBTRecIdx(recDb)
